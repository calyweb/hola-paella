      ...
      <section className="py-20 px-5 sm:px-8 bg-cream">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-5">
            {[
              { name: "Fruits de mer & Poulet", price: "18", desc: "Poulet, gambas." },
              { name: "Fruits de mer & Poisson", price: "19", desc: "Gambas, lotte." },
              { name: "Del Pueblo", price: "20", desc: "Travers de porc, poulet désossé, jambon Serrano, gambas décortiquées." },
              { name: "Royale", price: "21", desc: "Gambas, poulet, lotte, langoustines." },
            ].map((p) => (
