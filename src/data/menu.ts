...
export const menu: MenuItem[] = [
  ...
  // Version Bodéga = poulet désossé, gambas décortiquées — prêts à déguster, même prix
  {
    ...
    category: "paellas",
    tagline: "Poulet · Gambas.",
    description:
      "Poulet et gambas. Riz au safran, moules, calamars, chorizo, poivrons, oignons et petits pois.",
    price: 18,
    unit: "/ pers.",
    highlights: ["Poulet", "Gambas"],
  ...
  },
  {
    ...
    category: "paellas",
    tagline: "Gambas · Lotte.",
    description:
      "Gambas et lotte. Riz au safran, moules, calamars, chorizo, poivrons, oignons et petits pois.",
    price: 19,
    unit: "/ pers.",
    highlights: ["Gambas", "Lotte"],
  ...
  },
  {
    ...
    name: "Paella Royale",
    category: "paellas",
    tagline: "Gambas · Poulet · Lotte · Langoustines.",
    description:
      "Gambas, poulet, lotte et langoustines. Riz au safran, moules, calamars, chorizo, poivrons, oignons et petits pois.",
    price: 21,
    unit: "/ pers.",
    highlights: ["Gambas", "Poulet", "Lotte", "Langoustines"],
